...
# It prints out a report that lists the word count, number of different letters and number of different words

def main():
    doc_to_read = input("Please input the relative path to a document: (e.g. books/prince.txt): ")
    with open(doc_to_read) as f: # Opens the file and reads in the document contents
...
# A function that counts the total number and share of different words from the contents of the book
...
# A function that counts the letters from the contents of the book
